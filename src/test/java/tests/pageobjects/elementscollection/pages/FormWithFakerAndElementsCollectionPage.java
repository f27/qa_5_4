...
public class FormWithFakerAndElementsCollectionPage {
    ...
    public FormWithFakerAndElementsCollectionPage fillForm(Map<String, String> userData) {
    ...
    public Map<String,String> getTableData() {
        ...
        for(SelenideElement element: $$(dataTable).snapshot()){
            returnMap.put(element.$(dataTd).getText(), element.$(dataTd, 1).getText());
        }
        return returnMap;
    }
